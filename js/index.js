...
const show_layer = (divId) => {
  let bkBox = document.getElementById('burgerKingBox');
  let mnBox = document.getElementById('melonBox');
  let qzBox = document.getElementById('quizCatBox');
  let unBox = document.getElementById('undefinedBox');
  ...
  switch (divId) {
    ...
    case '4': unBox.style.display = "block"; break;
  }
}
